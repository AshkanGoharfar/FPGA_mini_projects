...
-- Date        : Fri May 17 19:35:20 2019
-- Host        : goharfar-PC running 64-bit Service Pack 1  (build 7601)
-- Command     : write_vhdl -mode funcsim -nolib -force -file {D:/Ashkan
--               works/PDS_HW4/P1/equation/equation.sim/sim_1/synth/func/top_tb_func_synth.vhd}
-- Design      : top
...
entity dist_mem_gen_0_dist_mem_gen_v8_0_11 is
  ...
  attribute C_ADDR_WIDTH of dist_mem_gen_0_dist_mem_gen_v8_0_11 : entity is 5;
  attribute C_DEFAULT_DATA : string;
  attribute C_DEFAULT_DATA of dist_mem_gen_0_dist_mem_gen_v8_0_11 : entity is "0";
  attribute C_DEPTH : integer;
  attribute C_DEPTH of dist_mem_gen_0_dist_mem_gen_v8_0_11 : entity is 32;
  ...
  attribute C_WIDTH of dist_mem_gen_0_dist_mem_gen_v8_0_11 : entity is 16;
  attribute ORIG_REF_NAME : string;
...
architecture STRUCTURE of top is
  ...
  signal f_OBUF : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal x_IBUF : STD_LOGIC_VECTOR ( 4 downto 0 );
  attribute syn_black_box : string;
  attribute syn_black_box of my_rom : label is "TRUE";
  attribute x_core_info : string;
  attribute x_core_info of my_rom : label is "dist_mem_gen_v8_0_11,Vivado 2016.4";
begin
...
\f_OBUF[0]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(0),
      O => f(0)
    );
\f_OBUF[10]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(10),
      O => f(10)
    );
\f_OBUF[11]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(11),
      O => f(11)
    );
\f_OBUF[12]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(12),
      O => f(12)
    );
\f_OBUF[13]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(13),
      O => f(13)
    );
\f_OBUF[14]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(14),
      O => f(14)
    );
\f_OBUF[15]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(15),
      O => f(15)
    );
\f_OBUF[1]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(1),
      O => f(1)
    );
\f_OBUF[2]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(2),
      O => f(2)
    );
\f_OBUF[3]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(3),
      O => f(3)
    );
\f_OBUF[4]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(4),
      O => f(4)
    );
\f_OBUF[5]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(5),
      O => f(5)
    );
\f_OBUF[6]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(6),
      O => f(6)
    );
\f_OBUF[7]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(7),
      O => f(7)
    );
\f_OBUF[8]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(8),
      O => f(8)
    );
\f_OBUF[9]_inst\: unisim.vcomponents.OBUF
     port map (
      I => f_OBUF(9),
      O => f(9)
    );
my_rom: entity work.dist_mem_gen_0
     port map (
      a(4 downto 0) => x_IBUF(4 downto 0),
      clk => clk_IBUF,
      spo(15 downto 0) => f_OBUF(15 downto 0)
    );
